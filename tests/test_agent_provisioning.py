...
def attached_hardware(monkeypatch: pytest.MonkeyPatch, **overrides: object) -> dict:
    ...
    def discover(*, probe_id: object = None, probe_named_by: str = "caller", before_connect: object = None, profile: object = None) -> dict:
...
def test_a_regeneration_that_raises_comes_back_as_a_quarantine(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def exploding(timeout_s: float = 10.0, *, probe_id: str | None = None, probe_named_by: str = "caller", before_connect: object = None, profile: object = None) -> dict:
        if callable(before_connect):
