...
| Class | Tools |
|---|---|
| changes nothing (`readOnlyHint: true`) | `debugger_info`, `debugger_probes_list`, `debug_get_session_status`, `debug_list_breakpoints`, `debug_get_stop_reason`, `debug_symbol_info`, `get_last_report`, `classify_last_error`, `com_ports_list`, `com_read`, `can_buses_list`, `can_read`, `bench_run_status`, `project_config_describe`, `project_config_reload_description`, `test_reactor_status` |
