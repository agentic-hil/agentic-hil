...
```bash
python -m pip install --user --upgrade "agentic-hil>=0.7.0"
agentic-hil --version
...
```bash
uvx --from "agentic-hil>=0.7.0" agentic-hil --version                           # transient diagnostic only
uvx --from git+https://github.com/agentic-hil/agentic-hil@v0.7.0 agentic-hil --version # transient repository check
uv tool install --upgrade "agentic-hil>=0.7.0"                                  # persistent user-local install
```
