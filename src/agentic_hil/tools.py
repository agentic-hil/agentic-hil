...
# attached hardware: entries already in it keep the permissions they have, an
# entry the discovery finds for the first time arrives with everything granted,
# and a file that has been deleted comes back granting everything. Set
# allow_config_write to false if this bench should not be regenerated from the
# agent side at all.
#
